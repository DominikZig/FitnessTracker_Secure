  ...
  <body>
    ...
    <div class="container">
      <div class="hero-unit">
        ...
        <sec:authorize ifAnyGranted="ROLE_ADMIN"><!--This button will only be displayed to Admins-->
        ...
        <a class="btn btn-warning" href="j_spring_security_logout"><!--j_spring_security_logout is the method that does all the hard work for us e
        .g kills the session, clears cookies etc.-->
          Logout >>
        </a>
      </div>
      <div>
